...
export const VolumeMediumIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const VolumeVariantOffIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const SpeedometerMediumIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const SpeedometerSlowIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const LightbulbOnIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const ContentSaveIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const FormatLetterCaseLowerIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const FormatLetterCaseUpperIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const BatteryCharging60Icon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const TrashCanOutlineIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const MenuUpIcon = (props) => (
  <SvgIcon {...props}>
    <path fill="currentColor" d="M7,15L12,10L17,15H7Z" />
  </SvgIcon>
);
export const MenuDownIcon = (props) => (
  <SvgIcon {...props}>
    <path fill="currentColor" d="M7,10L12,15L17,10H7Z" />
  </SvgIcon>
);

export const RadioBoxMarkedIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const RadioBoxBlankIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
...
export const MapMarkerRadiusIcon = (props) => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
